...
2. [A golang server](#a-golang-server)


## Design patterns
- [Factory design pattern](https://medium.com/@swabhavtechlabs/implementing-the-factory-design-pattern-in-golang-a-comprehensive-guide-36d351b53e3a) 
- [Factory Method](https://refactoring.guru/design-patterns/factory-method)


## Golang real project
- [fun server for golang](https://github.com/google/exposure-notifications-server)
- [Go shell in gitHub](https://github.com/sanurb/go-shell)
